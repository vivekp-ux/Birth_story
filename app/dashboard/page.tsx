    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-8 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          >
            <div className="w-10 h-10 rounded-full bg-[#e8f7f7] flex items-center justify-center text-[#3bbfbf] text-xl">
              ✦
            </div>
            <h3 className="font-semibold text-gray-800">Create New Story</h3>
            <p className="text-sm text-gray-500">Fill in birth details and generate a personalised booklet.</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-semibold text-gray-800">Preview &amp; Print</h3>
            <p className="text-sm text-gray-500">Preview the birth story booklet and download as PDF.</p>
          </Link>
        </div>
      </main>
    </div>
